...
namespace Foreman
{
    public partial class ShapePropertiesForm : Form
    {
        ...
        public ShapePropertiesForm(ShapeAnnotationElement element)
        {
            ...
            // Save snapshot so Cancel can restore everything
            ...
            // Initialise controls from current element state
            ...
            // Unhook checkbox event before setting Checked so it doesn't fire during init
            NoFillCheckBox.CheckedChanged -= NoFillCheckBox_CheckedChanged;
            NoFillCheckBox.Checked = (element.FillColor.A == 0);
            NoFillCheckBox.CheckedChanged += NoFillCheckBox_CheckedChanged;

            // Set fill controls directly without relying on events
            ...
            FillColorButton.ForeColor = (element.FillColor.R + element.FillColor.G + element.FillColor.B > 382) ? Color.Black : Color.White;
        ...
        private void FillColorButton_Click(object sender, EventArgs e)
        {
            ...
            {
                dlg.Color = Color.FromArgb(255, _element.FillColor.R, _element.FillColor.G, _element.FillColor.B);
                dlg.AnyColor = true;
                dlg.FullOpen = true;
        ...
        private void UpdateFillButton()
        {
            ...
            FillColorButton.ForeColor = (_element.FillColor.R + _element.FillColor.G + _element.FillColor.B > 382) ? Color.Black : Color.White;
        ...
        private void BorderColorButton_Click(object sender, EventArgs e)
        {
            using (ColorDialog dlg = new ColorDialog())
            {
                dlg.Color = _element.BorderColor;
                dlg.AnyColor = true;
                dlg.FullOpen = true;
                if (dlg.ShowDialog(this) == DialogResult.OK)
                {
        ...
        private void UpdateBorderButton()
        {
            ...
            BorderColorButton.ForeColor = (_element.BorderColor.R + _element.BorderColor.G + _element.BorderColor.B > 382) ? Color.Black : Color.White;
        }
